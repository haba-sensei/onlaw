...
!(function (e, t) {
    ...
    var k = (function (e) {
        ...
        try {
            N.apply((O = D.call(w.childNodes)), w.childNodes),
            ...
            return (
                ...
                ce(function (r, s, a, l) {
                    var c,
                        ...
                        m = n ? (o || (r ? e : f || i) ? [] : s) : y;
                    if ((n && n(y, m, a, l), i))
                        for (c = _e(m, d), i(c, [], a, l), u = c.length; u--; )
                            (p = c[u]) && (m[d[u]] = !(y[d[u]] = p));
                    if (r) {
                        if (o || e) {
                            if (o) {
                    ...
                    o = {
                        ...
                        then: function (t, i, o) {
                            ...
                            return w
                                .Deferred(function (e) {
                                    n[0][3].add(
                                        s(0, e, f(o) ? o : I, e.notifyWith)
                                    ),
                                        n[1][3].add(s(0, e, f(t) ? t : I)),
                                        n[2][3].add(s(0, e, f(i) ? i : H));
                                })
                                .promise();
                        },
                        promise: function (e) {
                ...
                for (c = (t = (t || "").match(P) || [""]).length; c--; )
                    if (
                        ...
                        s &&
                            !h.length &&
                            ((p.teardown &&
                                !1 !== p.teardown.call(e, f, y.handle)) ||
    ...
    function je(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Q.hasData(e) &&
                ((r = Q.access(e)), (s = w.extend({}, r)), Q.set(t, s));
        }
    }
    function Ne(e, t, n, i) {
        t = r(t);
        ...
        if (
            ...
            for (l = (a = w.map(ye(o, "script"), Oe)).length; p < h; p++)
                (c = o),
                    p !== g &&
                        ((c = w.clone(c, !0, !0)),
                        l && w.merge(a, ye(c, "script"))),
                    n.call(e[p], c, p);
            if (l)
                for (
                    u = a[a.length - 1].ownerDocument, w.map(a, Me), p = 0;
                    p < l;
                    p++
                )
                    (c = a[p]),
                        fe.test(c.type || "") &&
                            ...
                            (c.src && "module" !== (c.type || "").toLowerCase()
                                ...
                                : v(c.textContent.replace(Ce, ""), c, u));
        }
        return e;
    }
    function De(e, t, n) {
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (
                        r = r || ye(e), s = s || ye(u), i = 0, o = r.length;
                        i < o;
                        i++
                    )
                        je(r[i], s[i]);
        ...
        w.each(
            ...
            function (e, t) {
                w.fn[e] = function (e) {
                    for (
                        var n, i = [], o = w(e), r = o.length - 1, a = 0;
                        a <= r;
                        a++
                    )
                ...
                select: {
                    ...
                    set: function (e, t) {
                        for (
                            ...
                            ((i = o[s]).selected =
                                -1 < w.inArray(w.valHooks.option.get(i), r)) &&
                                (n = !0);
                    ...
                    o ||
                        ...
                        (c &&
                            ...
                            t.isPropagationStopped() &&
                                d.addEventListener(v, bt),
                            i[v](),
                            t.isPropagationStopped() &&
                                d.removeEventListener(v, bt),
    ...
    (Ht.href = xt.href),
        w.extend({
            ...
            ajax: function (t, n) {
                ...
                if (d.beforeSend && (!1 === d.beforeSend.call(f, E, d) || c))
                    return E.abort();
                if (
                    ((k = "abort"),
                    v.add(d.complete),
                ...
                function T(t, n, s, l) {
                    ...
                    c ||
                        ...
                        (E.statusText = (n || k) + ""),
                        p
                            ? m.resolveWith(f, [h, k, E])
                            : m.rejectWith(f, [E, k, y]),
                        E.statusCode(b),
                        (b = void 0),
                        u &&
    ...
    w.ajaxSetup({
                ...
                return (
                    (o = t.jsonpCallback =
                        f(t.jsonpCallback)
                            ...
                            : t.jsonpCallback),
                    a
                        ? (t[a] = t[a].replace(Yt, "$1" + o))
                        : !1 !== t.jsonp &&
                          (t.url +=
                              (_t.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
        ...
        (d.createHTMLDocument =
            (((Ut = y.implementation.createHTMLDocument("").body).innerHTML =
                "<form></form><form></form>"),
                    ...
                    (("body" !== a(o) || p(u)) &&
                        (d =
                            o !== n(o) && r(o)
                                ...
                                : i(o)),
                    r(o)
                        ? (((f = t(o)).x += o.clientLeft), (f.y += o.clientTop))
                        : u && (f.x = c(u))),
                {
                ...
                fn: function (e) {
                    ...
                    if (((a = { x: 0, y: 0 }), s)) {
                        if (o || r) {
                            ...
                            (c = "start" === c ? -f[b] : -h[b]),
                                (f = t.elements.arrow),
                                (f = i && f ? d(f) : { width: 0, height: 0 });
                            var A = t.modifiersData["arrow#persistent"]
    ...
    (function (e, t) {
        ...
        class J extends z {
            ...
            to(e) {
                ...
                if (this._isSliding)
                    return void q.one(this._element, "slid.bs.carousel", () =>
                        this.to(e)
                    );
            ...
            _addEventListeners() {
                this._config.keyboard &&
                    q.on(this._element, "keydown.bs.carousel", (e) =>
                        this._keydown(e)
                    ),
                    "hover" === this._config.pause &&
                        (q.on(this._element, "mouseenter.bs.carousel", (e) =>
                            this.pause(e)
                        ),
                        q.on(this._element, "mouseleave.bs.carousel", (e) =>
                            this.cycle(e)
                        )),
                    this._config.touch &&
                        this._touchSupported &&
            ...
            _addTouchEventListeners() {
                ...
                n.find(".carousel-item img", this._element).forEach((e) => {
                    ...
                    this._pointerEvent
                        ? (q.on(this._element, "pointerdown.bs.carousel", (t) =>
                              e(t)
                          ),
                          q.on(this._element, "pointerup.bs.carousel", (e) =>
                              i(e)
                          ),
                          this._element.classList.add("pointer-event"))
                        : (q.on(this._element, "touchstart.bs.carousel", (t) =>
                              e(t)
                          ),
                          q.on(this._element, "touchmove.bs.carousel", (e) =>
                              t(e)
                          ),
                          q.on(this._element, "touchend.bs.carousel", (e) =>
                              i(e)
                          ));
            }
            _keydown(e) {
                /input|textarea/i.test(e.target.tagName) ||
                    ("ArrowLeft" === e.key
                        ? (e.preventDefault(), this._slide(G))
                        : "ArrowRight" === e.key &&
                          (e.preventDefault(), this._slide(Q)));
            }
            _getItemIndex(e) {
                return (
                    (this._items =
                        e && e.parentNode
                            ? n.find(".carousel-item", e.parentNode)
                            : []),
            ...
            _slide(e, t) {
                ...
                if (this._element.classList.contains("slide")) {
                    s.classList.add(p),
                        ...
                        s.classList.add(u);
                    const e = () => {
                        s.classList.remove(u, p),
                            s.classList.add("active"),
                            o.classList.remove("active", p, u),
                            (this._isSliding = !1),
                            setTimeout(d, 0);
                    };
            ...
            static dataApiClickHandler(e) {
                ...
                i && (n.interval = !1),
                    J.carouselInterface(t, n),
                    i && k.get(t, "bs.carousel").to(i),
                    e.preventDefault();
            }
        }
        q.on(
            ...
            q.on(window, "load.bs.carousel.data-api", () => {
                ...
                for (let t = 0, n = e.length; t < n; t++)
                    J.carouselInterface(e[t], k.get(e[t], "bs.carousel"));
            }),
            x(J);
        ...
        class te extends z {
            ...
            show() {
                ...
                e &&
                    e.forEach((e) => {
                        i !== e && te.collapseInterface(e, "hide"),
                            t || k.set(e, "bs.collapse", null);
                    });
                ...
                this._queueCallback(
                    () => {
                        this._element.classList.remove("collapsing"),
                            ...
                            q.trigger(this._element, "shown.bs.collapse");
                    },
                    this._element,
                    !0
                ),
                    ...
                    this._queueCallback(
                        () => {
                            this.setTransitioning(!1),
                                ...
                                q.trigger(this._element, "hidden.bs.collapse");
                        },
                        this._element,
                        !0
                    );
        ...
        class pe extends z {
            ...
            show() {
                if (f(this._element) || this._menu.classList.contains("show"))
                    return;
                const e = pe.getParentFromElement(this._element),
                    n = { relatedTarget: this._element };
                if (
                    !q.trigger(this._element, "show.bs.dropdown", n)
                        .defaultPrevented
                ) {
                    if (this._inNavbar)
            ...
            _selectMenuItem(e) {
                ...
                "ArrowUp" === e.key && i > 0 && i--,
                    "ArrowDown" === e.key && i < t.length - 1 && i++,
                    (i = -1 === i ? 0 : i),
                    t[i].focus();
            }
            static dropdownInterface(e, t) {
                ...
                if (
                    (n || (n = new pe(e, "object" == typeof t ? t : null)),
                    "string" == typeof t)
                ) {
                    if (void 0 === n[t])
                        throw new TypeError(`No method named "${t}"`);
            ...
            static dataApiKeydownHandler(e) {
                ...
                if ("Escape" === e.key)
                    return i().focus(), void pe.clearMenus();
                t || ("ArrowUp" !== e.key && "ArrowDown" !== e.key)
                    ? t && "Space" !== e.key
                        ? pe.getInstance(i())._selectMenuItem(e)
                        : pe.clearMenus()
                    : i().click();
            }
        }
        ...
        const he = () => {
            ...
            de = (e = he()) => {
                fe(),
                    ge("body", "paddingRight", (t) => t + e),
                    ge(
                        ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
                        "paddingRight",
                        (t) => t + e
                    ),
                    ge(".sticky-top", "marginRight", (t) => t - e);
            },
            fe = () => {
                const e = document.body.style.overflow;
                e && Y.setDataAttribute(document.body, "overflow", e),
            ...
            ge = (e, t, i) => {
                ...
                n.find(e).forEach((e) => {
                    ...
                    Y.setDataAttribute(e, t, n),
                        (e.style[t] = i(Number.parseFloat(r)) + "px");
                });
            },
            ye = () => {
                me("body", "overflow"),
                    me("body", "paddingRight"),
                    me(
                        ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
                        "paddingRight"
                    ),
                    me(".sticky-top", "marginRight");
            },
            me = (e, t) => {
                n.find(e).forEach((e) => {
                    ...
                    void 0 === n
                        ...
                        : (Y.removeDataAttribute(e, t), (e.style[t] = n));
                });
            },
            ve = {
                isVisible: !0,
        ...
        class xe {
            ...
            dispose() {
                this._isAppended &&
                    (q.off(this._element, "mousedown.bs.backdrop"),
            ...
            _emulateAnimation(e) {
                ...
                q.one(this._getElement(), "transitionend", () => w(e)),
                    p(this._getElement(), t);
            }
        }
        ...
        class ke extends z {
            ...
            hide(e) {
                if (
                    ...
                    return;
                if (q.trigger(this._element, "hide.bs.modal").defaultPrevented)
                    return;
                this._isShown = !1;
            ...
            dispose() {
                [window, this._dialog].forEach((e) => q.off(e, ".bs.modal")),
                    ...
                    this._queueCallback(
                        () => {
                            this._config.focus && this._element.focus(),
                                (this._isTransitioning = !1),
                                q.trigger(this._element, "shown.bs.modal", {
                                    relatedTarget: e,
                                });
                        },
                        this._dialog,
                ...
                (this._element.style.display = "none"),
                    ...
                    this._backdrop.hide(() => {
                        document.body.classList.remove("modal-open"),
                            ...
                            ye(),
                            q.trigger(this._element, "hidden.bs.modal");
                    });
            }
            _showBackdrop(e) {
        ...
        class Se extends z {
            ...
            static jQueryInterface(e) {
                return this.each(function () {
                    const t =
                        k.get(this, "bs.offcanvas") ||
                        new Se(this, "object" == typeof e ? e : {});
                    if ("string" == typeof e) {
                        if (
                            void 0 === t[e] ||
                            e.startsWith("_") ||
        ...
        q.on(
            ...
            function (e) {
                ...
                i && i !== t && Se.getInstance(i).hide(),
                    (k.get(t, "bs.offcanvas") || new Se(t)).toggle(this);
            }
        ),
            q.on(window, "load.bs.offcanvas.data-api", () => {
                n.find(".offcanvas.show").forEach((e) =>
                    (k.get(e, "bs.offcanvas") || new Se(e)).show()
                );
            }),
            x(Se);
        const Ae = new Set([
            ...
            Oe = (e, t) => {
                ...
                if (t.includes(n))
                    return (
                        !Ae.has(n) ||
                        Boolean(Ce.test(e.nodeValue) || Le.test(e.nodeValue))
                    );
        ...
        class Re extends z {
            ...
            _initializeOnDelegatedTarget(e, t) {
                ...
                return (
                    (t = t || k.get(e.delegateTarget, n)) ||
                        ((t = new this.constructor(
                            e.delegateTarget,
                            this._getDelegateConfig()
                        )),
                        k.set(e.delegateTarget, n, t)),
                    t
                );
            }
            _getOffset() {
            ...
            _setListeners() {
                this._config.trigger.split(" ").forEach((e) => {
                    if ("click" === e)
                        ...
                        q.on(this._element, t, this._config.selector, (e) =>
                            this._enter(e)
                        ),
                            q.on(this._element, n, this._config.selector, (e) =>
                                this._leave(e)
                            );
                    }
                }),
            ...
            static jQueryInterface(e) {
                return this.each(function () {
                    ...
                    if (
                        ...
                        (t || (t = new Re(this, n)), "string" == typeof e)
                    ) {
                        if (void 0 === t[e])
                            throw new TypeError(`No method named "${e}"`);
                        t[e]();
        ...
        class Be extends z {
            constructor(e, t) {
                super(e),
                    ...
                    q.on(this._scrollElement, "scroll.bs.scrollspy", () =>
                        this._process()
                    ),
                    this.refresh(),
                    this._process();
        ...
        q.on(
            ...
            function (e) {
                ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
                    f(this) || (k.get(this, "bs.tab") || new Ve(this)).show();
            }
        ),
            x(Ve);
        const $e = {
        ...
        class Qe extends z {
                    ...
                    this._queueCallback(
                        () => {
                            this._element.classList.remove("showing"),
                                this._element.classList.add("show"),
                                q.trigger(this._element, "shown.bs.toast"),
                        ...
                        this._queueCallback(
                            () => {
                                this._element.classList.add("hide"),
                                    q.trigger(this._element, "hidden.bs.toast");
                            },
                            this._element,
                            this._config.animation
                        )));
            ...
            _setListeners() {
                q.on(
                    ...
                    q.on(this._element, "mouseover.bs.toast", (e) =>
                        this._onInteraction(e, !0)
                    ),
                    q.on(this._element, "mouseout.bs.toast", (e) =>
                        this._onInteraction(e, !1)
                    ),
                    q.on(this._element, "focusin.bs.toast", (e) =>
                        this._onInteraction(e, !0)
                    ),
                    q.on(this._element, "focusout.bs.toast", (e) =>
                        this._onInteraction(e, !1)
                    );
            }
            _clearTimeout() {
            ...
            static jQueryInterface(e) {
                return this.each(function () {
                    ...
                    if (
                        (t || (t = new Qe(this, "object" == typeof e && e)),
                        "string" == typeof e)
                    ) {
                        if (void 0 === t[e])
                            throw new TypeError(`No method named "${e}"`);
    ...
    (function (e, t) {
        ...
        function c(e, t) {
            w[t] = setTimeout(function () {
                return (
                    e.isAlive &&
                    e.element.classList.remove(x.state.scrolling(t))
                );
        ...
        function h(e, t, n, i, o) {
            ...
            !(function (e, t, n, i, o) {
                ...
                (e.reach[l] = null),
                    ...
                    t &&
                        (d.dispatchEvent(p("ps-scroll-" + l)),
                        0 > t
                            ? d.dispatchEvent(p("ps-scroll-" + c))
                            : 0 < t && d.dispatchEvent(p("ps-scroll-" + h)),
                        i && u(e, l)),
                    e.reach[l] &&
                        (t || o) &&
                        d.dispatchEvent(p("ps-" + l + "-reach-" + e.reach[l]));
            })(e, n, r, i, o);
        }
        function d(e) {
            ...
            (e.containerWidth = n(r.width)),
                ...
                e.containerWidth + e.settings.scrollXMarginOffset <
                    ...
                    ? ((e.scrollbarXActive = !0),
                      ...
                      (e.scrollbarXWidth = y(
                          e,
                          d((e.railXWidth * e.containerWidth) / e.contentWidth)
                      )),
                      (e.scrollbarXLeft = d(
        ...
        function v(e, t) {
            ...
            function i() {
                c(e, f),
                    e[y].classList.remove(x.state.clicking),
                    ...
                    function o(n, o) {
                        ...
                        if (l > a) {
                            if (
                                ...
                                return (
                                    0 === window.scrollY && 0 < o && T.isChrome
                                );
                        } else if (
                            a > l &&
                            ((0 > n &&
                                s === i.contentWidth - i.containerWidth) ||
                                (0 < n && 0 === s))
                        )
                            return !0;
                        return !0;
            ...
            A = function (e, r) {
                ...
                (this.scrollbarXBottom = parseInt(u.bottom, 10)),
                    isNaN(this.scrollbarXBottom)
                        ? ((this.isScrollbarXUsingBottom = !1),
                          (this.scrollbarXTop = d(u.top)))
                        : (this.isScrollbarXUsingBottom = !0),
                    (this.railBorderXWidth =
                        d(u.borderLeftWidth) + d(u.borderRightWidth)),
                    i(this.scrollbarXRail, { display: "block" }),
                    (this.railXMarginWidth =
                        d(u.marginLeft) + d(u.marginRight)),
                ...
                (this.scrollbarYRight = parseInt(p.right, 10)),
                    ...
                    (this.railBorderYWidth =
                        d(p.borderTopWidth) + d(p.borderBottomWidth)),
                    i(this.scrollbarYRail, { display: "block" }),
                    (this.railYMarginHeight =
                        d(p.marginTop) + d(p.marginBottom)),
        ...
        return (
            (A.prototype.update = function () {
                this.isAlive &&
                    ...
                    i(this.scrollbarYRail, { display: "block" }),
                    (this.railXMarginWidth =
                        d(n(this.scrollbarXRail).marginLeft) +
                        d(n(this.scrollbarXRail).marginRight)),
                    (this.railYMarginHeight =
                        d(n(this.scrollbarYRail).marginTop) +
                        d(n(this.scrollbarYRail).marginBottom)),
    ...
    (function (e, t, n, i) {
            ...
            (n.isFirst = !!r),
                ...
                (function (e, t) {
                    ...
                    (t.overallVelocityX = c.x),
                        ...
                        E(n, t);
                    var u = e.element;
                    f(t.srcEvent.target, u) && (u = t.srcEvent.target),
                        (t.target = u);
                })(e, n),
        ...
        function D(e, t) {
            ...
            return (
                t & (we | _e) && (n = b(n.concat(i), "identifier", !0)), [n, i]
            );
        }
        function P() {
            (this.evTarget = Xe),
        ...
        function ee(e, t) {
            (this.options = ie({}, Z.defaults, t || {})),
                ...
                (this.input = (function (e) {
                    return new (e.options.inputClass ||
                        (fe ? j : ge ? P : de ? H : M))(e, k);
                })(this)),
        ...
        _.prototype = {
            ...
            init: function () {
                this.evEl && h(this.element, this.evEl, this.domHandler),
                    ...
                    this.evWin &&
                        h(w(this.element), this.evWin, this.domHandler);
            },
            destroy: function () {
                this.evEl && d(this.element, this.evEl, this.domHandler),
                    this.evTarget &&
                        d(this.target, this.evTarget, this.domHandler),
                    this.evWin &&
                        d(w(this.element), this.evWin, this.domHandler);
            },
        };
            ...
            dropRecognizeWith: function (e) {
                return (
                    r(e, "dropRecognizeWith", this) ||
                        ((e = Y(e, this)), delete this.simultaneous[e.id]),
                    this
                );
            },
            ...
            recognize: function (e) {
                ...
                return u(this.options.enable, [this, t])
                    ? (this.state & (st | at | lt) && (this.state = nt),
                      ...
                      void (
                          this.state & (it | ot | rt | at) && this.tryEmit(t)
                      ))
            ...
            l(V, B, {
                ...
                attrTest: function (e) {
                    return (
                        ...
                        (this.state & it ||
                            (!(this.state & it) && this.directionTest(e)))
                    );
                },
                emit: function (e) {
                ...
                process: function (e) {
                    ...
                    if (i && r && n) {
                        ...
                        var s =
                            ...
                            a =
                                !this.pCenter ||
                                L(this.pCenter, e.center) < t.posThreshold;
                        if (
        ...
        var e,
            ...
            l = {
                ...
                update: function () {
                    l.now(function (t) {
                        t.name !== e &&
                            (a.emit(t.name), a.emit("change", t), (e = t.name));
                    });
                },
            };
        return (
            ...
            n.addEventListener("DOMContentLoaded", function () {
                (r =
                    "none" !==
                    t.getComputedStyle(i, null).getPropertyValue("clear")),
                    l.update();
            }),
            {
            ...
            function t(t, i) {
                ...
                if (
                    ...
                    (b = e(
                        ...
                        y &&
                            (i.theme
                                ? (w.css(f), w.addClass("ui-widget-content"))
                                : w.css(r)),
                    ...
                    var S =
                        p &&
                        (!e.support.boxModel ||
                            e("object,embed", g ? null : t).length > 0);
                    if (u || S) {
                        if (
                            (g &&
                                i.allowBodyStretch &&
    ...
    function () {
            ...
            v = {
                ...
                w = function (e, t) {
                    ...
                    if (
                        ...
                        if (((n = i.getAttribute("data-pace-" + e)), !t))
                            return n;
                        try {
                            return JSON.parse(n);
                        } catch (e) {
                    ...
                    if (null != (i = this.bindings) && i[s]) {
                        for (n = 0, r = []; n < this.bindings[s].length; )
                            (t = (o = this.bindings[s][n]).handler),
                                ...
                                o
                                    ? r.push(this.bindings[s].splice(n, 1))
                                    : r.push(n++);
                        return r;
                    }
                },
        ...
        function se(e) {
            (this.source = e),
                ...
                null != this.source &&
                    (this.progress = L(this.source, "progress"));
        }
        K(J, (B = Error)),
            (r = J),
            ...
            (Z.prototype.update = function (e) {
                return (
                    (this.progress = e), s.trigger("progress", e), this.render()
                );
            }),
            ...
            (ee.prototype.trigger = function (e, t) {
                ...
                if (null != this.bindings[e]) {
                    for (
                        s = [], i = 0, o = (r = this.bindings[e]).length;
                        i < o;
                        i++
                    )
            ...
            (s.ignore = function () {
                ...
                return (
                    E.unshift("ignore"), (t = e.apply(null, t)), E.shift(), t
                );
            }),
            (s.track = function () {
                var e = arguments[0],
            ...
            (N = function (e) {
                ...
                if (!E.length && A.ajax) {
                    ...
                    if (
                        ((e = e.toUpperCase()),
                        0 <= Q.call(A.ajax.trackMethods, e))
                    )
                        return !0;
                }
                return !1;
            ...
            (j = function (e) {
                for (
                    var t, n = A.ajax.ignoreURLs, i = 0, o = n.length;
                    i < o;
                    i++
                )
            ...
            (_ = function () {
                ...
                if (!j(r))
                    return s.running ||
                        (!1 === A.restartOnRequestAfter && "force" !== N(i))
                        ? void 0
                        : ((n = arguments),
                          "boolean" ==
                              typeof (r = A.restartOnRequestAfter || 0) &&
                              (r = 0),
                          setTimeout(function () {
                              var e,
                                  r,
                ...
                (this.progress = 0),
                    ...
                    (t = setInterval(function () {
                        ...
                        return (
                            ...
                            (e = f(o)),
                            ++i >= A.eventLag.minSamples &&
                            e < A.eventLag.lagThreshold
            ...
            (se.prototype.tick = function (e, t) {
                return (
                    100 <= (t = null == t ? L(this.source, "progress") : t) &&
                        (this.done = !0),
                    t === this.last
                        ? (this.sinceLastUpdate += e)
                        : (this.sinceLastUpdate &&
                              (this.rate =
                                  (t - this.last) / this.sinceLastUpdate),
                          (this.catchup = (t - this.progress) / A.catchupTime),
                    ...
                    (this.progress = Math.min(
                        this.lastProgress + A.maxProgressPerFrame,
                        this.progress
                    )),
            ...
            (T = function () {
                ...
                for (
                    s.sources = P = [],
                        t = 0,
                        o = (a = ["ajax", "elements", "document", "eventLag"])
                            .length;
                    t < o;
                    t++
                )
                    !1 !== A[(e = a[t])] && P.push(new l[e](A[e]));
                for (
                    i = 0,
                        r = (p = null != (u = A.extraSources) ? u : []).length;
                    i < r;
                    i++
                )
                    (D = p[i]), P.push(new D(A));
            ...
            T = {
                ...
                handle: function (e, t, n, i, o) {
                    ...
                    return (
                        e.forEach(function (e) {
                            r.processors[e] &&
                                (t = r.processors[e].process(t, n, i, o));
                        }),
                        t
                    );
                },
                        ...
                        },
                        {
                            ...
                            value: function (e, t, n) {
                                ...
                                this.queue.forEach(function (n) {
                                    ...
                                    this.emit("loaded", s),
                                    (this.queue = this.queue.filter(function (
                                        e
                                    ) {
                                        return !e.done;
                                    }));
                            ...
                            if (
                                ...
                                (a.logger = h),
                                    ...
                                    this.modules.i18nFormat &&
                                        ...
                                        a.i18nFormat.init &&
                                            a.i18nFormat.init(this)),
                                    (this.translator = new A(
                                        this.services,
                                        this.options
                                    )),
                            ...
                            if (
                                ...
                                i
                                    ...
                                    this.options.preload &&
                                        this.options.preload.forEach(function (
                                            e
                                        ) {
                                            return r(e);
                                        }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this,
                                ...
                                s = new o(r);
                            return (
                                ["store", "services", "language"].forEach(
                                    function (t) {
                                        s[t] = e[t];
                                    }
                                ),
            ...
            function (e, t, n) {
                ...
                e.exports = function (e) {
                    var t,
                        ...
                        v = c(h);
                    if (
                        (y && (g = i(g, f > 2 ? arguments[2] : void 0, 2)),
                        null == v || (d == Array && s(v)))
                    )
                        for (n = new d((t = a(h.length))); t > m; m++)
                            l(n, m, y ? g(h[m], m) : h[m]);
                    else
                        for (
                            p = v.call(h), n = new d();
                            ...
                            l(n, m, y ? r(p, g, [u.value, m], !0) : u.value);
                    return (n.length = m), n;
                };
            },
            function (e, t, n) {
            ...
            return this.each(function () {
                        ...
                        ? (0 < r.decimals && "." === e) ||
                          ...
                          (n = (function (e) {
                              switch (r.forcestepdivisibility) {
                                  case "round":
                                      return (
                                          Math.round(e / r.step) * r.step
                                      ).toFixed(r.decimals);
                                  case "floor":
                                      return (
                                          Math.floor(e / r.step) * r.step
                                      ).toFixed(r.decimals);
                                  case "ceil":
                                      return (
                                          Math.ceil(e / r.step) * r.step
                                      ).toFixed(r.decimals);
                                  default:
                ...
                function k() {
                    ...
                    isNaN(u) ? (u = _()) : ((e = w()), (u += e)),
                        null !== r.max &&
                            u > r.max &&
                            ((u = r.max), g.trigger("touchspin.on.max"), A()),
                        c.input.val(
                            r.callback_after_calculation(
                                Number(u).toFixed(r.decimals)
                            )
                        ),
                ...
                function E() {
                    ...
                    isNaN(u) ? (u = _()) : ((e = w()), (u -= e)),
                        null !== r.min &&
                            u < r.min &&
                            ((u = r.min), g.trigger("touchspin.on.min"), A()),
                        c.input.val(
                            r.callback_after_calculation(
                                Number(u).toFixed(r.decimals)
                            )
                                ...
                                ? ("" !==
                                  ...
                                  (c = {
                                      ...
                                      prefix: e(
                                          ".bootstrap-touchspin-prefix",
                                          l
                                      ).addClass(r.prefix_extraclass),
                                      postfix: e(
                                          ".bootstrap-touchspin-postfix",
                                          l
                                      ).addClass(r.postfix_extraclass),
                                  }),
                                  b(),
